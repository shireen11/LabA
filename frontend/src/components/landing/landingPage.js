    ...
    return (
        <div>
            <div style={{ float: "right", padding: "5px" }}>
                <button  style={{ margin: "7px",  borderRadius: "5px" }}><a href="/studentLogin"> student login</a></button>
                <button style={{ margin: "7px", borderRadius: "5px" }}><a href="/facultyLogin"> Faculty login</a></button>

            </div>
            
            <h1 style={{ textAlign: "center", paddingTop: "70px", WebkitTextFillColor: "white", fontFamily: "Times New Roman"}}>Welcome to Walchand College of Engineering</h1>
